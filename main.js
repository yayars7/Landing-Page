// ============================================================
// MAIN FUNCTIONS - Eco Bee Landing Page (FULL)
// ============================================================

console.log('✅ Eco Bee - main.js loading...');
...
// Try to play when sections loaded
...
function showResult() {
  ...
  // Update result based on yesCount
...
function submitRequest(event) {
  ...
  document.querySelector('.request-form-wrapper')?.scrollIntoView({ 
    behavior: 'smooth', 
    block: 'center' 
  });
...
function openVideoZoom(element, index) {
  ...
  setTimeout(function() {
    ...
    if (activeSlide) {
      ...
      // Try to go full screen automatically
      try {
  ...
  window.videoZoomSwiper.on('slideChange', function() {
    ...
    setTimeout(function() {
      ...
      if (activeSlide && isVideoModalOpen) {
        ...
        // Auto full screen on slide change
        try {
...
// Hero swiper click
document.querySelector('.heroSwiper .swiper-wrapper')?.addEventListener('click', function(e) {
  if (e.target.closest('.swiper-button-next') || 
      e.target.closest('.swiper-button-prev') || 
      e.target.closest('.swiper-pagination')) return;
  openLightbox();
});
...
document.querySelector('.btn-premium[href="#contact"]')?.addEventListener('click', function(e) {
  e.preventDefault();
  var contactSection = document.getElementById('contact');
  if (contactSection) contactSection.scrollIntoView({ behavior: 'smooth', block: 'start' });
});
...
// ============================================================
// COUNTDOWN TIMER (dalam offer-pricing)
// ============================================================
...
if (document.getElementById('countdownTimer')) {
  ...
  // Start countdown when sections loaded
  document.addEventListener('sectionsLoaded', function() {
  ...
  // Backup
  setTimeout(function() {
    if (document.getElementById('hours') && !window.countdownStarted) {
...
console.log('✅ Eco Bee - main.js loaded successfully!');